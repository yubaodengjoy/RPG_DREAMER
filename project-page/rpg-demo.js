...
(() => {
  ...
  const games = {
    'world-40': {
      ...
      src: `${gameAssetBase}src-40/src/dist/index.html?v=20260904-chapter-packs-01`,
    ...
    'magic-brush': {
      title: '神笔：移命录',
      meta: 'Long-horizon generated RPG · Chinese',
      src: `${gameAssetBase}src-41/src/dist/index.html?v=20260904-chapter-packs-01`,
    ...
    'world-42': {
      ...
      src: `${gameAssetBase}src-42/src/dist/index.html?v=20260904-chapter-packs-01`,
    ...
    'vanishing-emperor': {
      ...
      meta: 'Long-horizon generated RPG · English',
      src: `${gameAssetBase}src-43/src/dist/index.html?v=20260904-chapter-packs-01`,
    ...
    'journey-west': {
      title: '西游·女儿国情劫',
      meta: 'Long-horizon generated RPG · Chinese',
      src: `${gameAssetBase}src-44/src/dist/index.html?v=20260904-chapter-packs-01`,
  ...
  window.addEventListener('message', (event) => {
    ...
    if (event.data.type === 'loading') {
      ...
      state.progressLabel = event.data.label
        || `Mounting world assets ${Math.round(value * 100)}%`;
      if (id === activeId) syncActiveUi();
      return;
    }
